...
3. Download a copy of **twitter_handles.csv** by opening a browser and typing +++https://github.com/tayganr/purviewlab/raw/main/assets/twitter_handles.csv+++. Right-click within the body of the content, and click **Save as**.
...
1. Open the **Microsoft Purview Governance Portal**, navigate to **Data map** > **Sources** and click **New Scan** within the Azure Data Lake Storage Gen2 tile. 
